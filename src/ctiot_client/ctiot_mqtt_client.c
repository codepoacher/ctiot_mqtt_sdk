...
cJSON_Hooks g_cJSON_Hooks = {OS_MALLOC,OS_FREE};
...
static void ctiot_mqtt_disconnect( MQTTClient *client, Network *n)
{
    ...
    CTIOT_LOG(LOG_ERR, "mqtt_disconnect");
}
...
int  ctiot_mqtt_login(const mqtt_device_info_s* device_info, mqtt_client_s* handle)
{
    ...
    while(true)
    {
        ...
        ctiot_mqtt_destroy_data_connection_info(&data);
        CTIOT_LOG(LOG_DEBUG, "CONNACK : %d", rc);
        if(MQTT_SUCCESS != rc)
        {
...
CTIOT_MSG_STATUS ctiot_mqtt_encode_data_report_signal_report(DATA_REPORT_SIGNAL_REPORT* para,char** payload)
{
	...
	mqttPara.paraList[0].paraName = "rsrp";
	mqttPara.paraList[0].u.ctiotInt.min = -32768;
	mqttPara.paraList[0].u.ctiotInt.max = 32767;
	//mqttPara.paraList[0].u.ctiotInt.val = para->rsrp;
	mqttPara.paraList[0].u.ctiotInt.val = -87;

	mqttPara.paraList[1].ctiotParaType = CTIOT_INT;
	mqttPara.paraList[1].paraName = "sinr";
	mqttPara.paraList[1].u.ctiotInt.min = -32768;
	mqttPara.paraList[1].u.ctiotInt.max = 32767;
	//mqttPara.paraList[1].u.ctiotInt.val = para->sinr;
	mqttPara.paraList[1].u.ctiotInt.val = 10.2;

	mqttPara.paraList[2].ctiotParaType = CTIOT_INT;
	mqttPara.paraList[2].paraName = "pci";
	mqttPara.paraList[2].u.ctiotInt.min = -32768;
	mqttPara.paraList[2].u.ctiotInt.max = 32767;
	//mqttPara.paraList[2].u.ctiotInt.val = para->pci;
	mqttPara.paraList[2].u.ctiotInt.val = 62;

	mqttPara.paraList[3].ctiotParaType = CTIOT_INT;
	mqttPara.paraList[3].paraName = "ecl";
	mqttPara.paraList[3].u.ctiotInt.min = -32768;
	mqttPara.paraList[3].u.ctiotInt.max = 32767;
	//mqttPara.paraList[3].u.ctiotInt.val = para->ecl;
	mqttPara.paraList[3].u.ctiotInt.val = 3;

	mqttPara.paraList[4].ctiotParaType = CTIOT_INT;
	mqttPara.paraList[4].paraName = "cell_id";
	mqttPara.paraList[4].u.ctiotInt.min = -2147483648;
	mqttPara.paraList[4].u.ctiotInt.max = 2147483647;
	//mqttPara.paraList[4].u.ctiotInt.val = para->cell_id;
	mqttPara.paraList[4].u.ctiotInt.val = 0x71dfb1f;
...
CTIOT_MSG_STATUS ctiot_mqtt_encode_data_report_data_report(DATA_REPORT_DATA_REPORT* para,char** payload)
{
	...
	mqttPara.paraList[0].paraName = "wifi_pwd";
	mqttPara.paraList[0].u.ctiotStr.minLen = 0;
	mqttPara.paraList[0].u.ctiotStr.maxLen = 2048;
	//mqttPara.paraList[0].u.ctiotStr.val = para->wifi_pwd;
	mqttPara.paraList[0].u.ctiotStr.val = "admin";

	mqttPara.paraList[1].ctiotParaType = CTIOT_STR;
	mqttPara.paraList[1].paraName = "wifi_name";
	mqttPara.paraList[1].u.ctiotStr.minLen = 0;
	mqttPara.paraList[1].u.ctiotStr.maxLen = 2048;
	//mqttPara.paraList[1].u.ctiotStr.val = para->wifi_name;
	mqttPara.paraList[1].u.ctiotStr.val = "wifi-710015";
